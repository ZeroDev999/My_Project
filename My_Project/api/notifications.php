    ...
    try {
        ...
        foreach ($notifications as &$notification) {
            if ($notification['related_task_id']) {
                $notification['link'] = BASE_URL . 'tasks/view.php?id=' . $notification['related_task_id'];
            } elseif ($notification['related_project_id']) {
                $notification['link'] = BASE_URL . 'projects/view.php?id=' . $notification['related_project_id'];
            }
        }
