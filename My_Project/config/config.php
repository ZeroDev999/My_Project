...
define('BASE_URL', 'https://nc-it-projects.com/My_Project/');
...
// Configure these for your hosting provider's SMTP server
...
define('FROM_EMAIL', getenv('FROM_EMAIL') ?: 'noreply@nc-it-projects.com');
